...
class BlogPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (context) => BlogPageController(currentIndex: 0),
      child: Padding(
        padding:
            ...
            Row(
              ...
              children: carouselIndexes.map((int i) {
                return IconButton(
                  ...
                  icon: Consumer<BlogPageController>(
                    builder: (
                      ...
                      final int currentIndex = screenSize.width >= 1050 &&
                              blogPageController.currentIndex > 2
                          ? blogPageController.currentIndex % 3
                          : blogPageController.currentIndex;
                      return Icon(
                        Icons.circle,
                ...
                builder: (
                  ...
                  return CarouselSlider(
                    options: CarouselOptions(
                      height: 630,
                      initialPage: blogPageController.currentIndex,
                      onPageChanged:
